...
modules-y = attr busybox coreboot cryptsetup flashrom kexec-tools pciutils libaio libtirpc linux lvm2 musl outils popt util-linux xz zfs zlib
...
util-linux: musl
xz: musl
zfs: attr libaio libtirpc musl util-linux zlib
zlib: musl
